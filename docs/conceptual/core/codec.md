...
Results indicate whether certain operations were successful or unsuccessful. Each variant can contain additional data, such as a resulting value of an operation or an error message.
